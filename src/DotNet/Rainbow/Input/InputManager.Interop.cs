...
namespace Rainbow.Input
{
    ...
    public static partial class InputManager
    {
        ...
        internal static unsafe void OnPointerBegan(
        ...
        internal static unsafe void OnPointerCanceled(
            [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=1)] Pointer[] pointers,
            uint count)
        {
        ...
        internal static unsafe void OnPointerEnded(
            [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=1)] Pointer[] pointers,
            uint count)
        {
        ...
        internal static unsafe void OnPointerMoved(
            [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=1)] Pointer[] pointers,
            uint count)
        {
