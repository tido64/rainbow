...
#    define LOGD(...)                                                          \
        __android_log_print(ANDROID_LOG_DEBUG, "Rainbow", __VA_ARGS__)
#    define LOGE(...)                                                          \
        __android_log_print(ANDROID_LOG_ERROR, "Rainbow", __VA_ARGS__)
#    define LOGF(...)                                                          \
        __android_log_print(ANDROID_LOG_FATAL, "Rainbow", __VA_ARGS__)
#    define LOGI(...)                                                          \
        __android_log_print(ANDROID_LOG_INFO, "Rainbow", __VA_ARGS__)
#    define LOGW(...)                                                          \
        __android_log_print(ANDROID_LOG_WARN, "Rainbow", __VA_ARGS__)
#else
...
#        define LOG_F(level, fmt, ...)                                         \
            printf(LOG_FMT(level, fmt) "%c",                                   \
                   rainbow::Chrono::system_now().count() LOG_EX(__VA_ARGS__))
