...
NS_B2_LUA_BEGIN
{
	...
	{
		return set1f(L, [](StableWorld *world, const float ptm) {
			world->SetPTM(ptm);
		});
	}
	...
	{
		return set1b(L, [](StableWorld *world, const bool enable) {
	...
	{
		return set1b(L, [](StableWorld *world, const bool allow) {
	...
	{
		return set1b(L, [](StableWorld *world, const bool warm) {
	...
	{
		return set1b(L, [](StableWorld *world, const bool continuous) {
	...
	{
		return set1b(L, [](StableWorld *world, const bool sub_stepping) {
	...
	{
		return set2f(L, [](StableWorld *world, const float gx, const float gy) {
	...
	{
		return set2f(L, [](StableWorld *world, const float x0, const float y0) {
