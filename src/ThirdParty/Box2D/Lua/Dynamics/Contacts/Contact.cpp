...
NS_B2_LUA_BEGIN
{
	...
	int Contact::GetManifold(lua_State *)
	{
		return -1;
	}

	int Contact::GetWorldManifold(lua_State *)
	{
		return -1;
	}
	...
	{
		return set1b(L, [](b2Contact *contact, const bool enabled) {
	...
	{
		return set1f(L, [](b2Contact *contact, const float friction) {
	...
	{
		return set1f(L, [](b2Contact *contact, const float r) {
	...
	{
		return set1f(L, [](b2Contact *contact, const float speed) {
