...
auto b2::lua::ShapesInit(lua_State* L) -> int
{
...
auto b2::lua::MassData(lua_State* L, const b2MassData& mass) -> int
{
...
auto b2::lua::Shape(lua_State* L, b2Shape* shape) -> int
{
...
auto b2::lua::GetShape(lua_State* L) -> b2Shape*
{
